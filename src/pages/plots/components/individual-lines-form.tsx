...
export type IndividualLinesFormSubmitHandler = (
  values: IndividualLinesAttributes,
  actions: FormikHelpers<IndividualLinesAttributes>
) => void;

export interface IndividualLinesFormProps {
  initialFocusRef?: React.MutableRefObject<FocusableElement | null>;
  onCancel?: () => void;
  onSubmit: IndividualLinesFormSubmitHandler;
}
...
export default IndividualLinesForm;
