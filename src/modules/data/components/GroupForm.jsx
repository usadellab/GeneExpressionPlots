    ...
    try {
      ...
      for (const file of files) {
        ...
        if (dataTable.colNames.length === 0) {
          const rows = Object.entries(table.rows).reduce(
            (obj, [rowName, rowCells]) =>
              Object.assign(obj, {
        ...
        dataTable.addColumn(
          `${this.state.groupName}*${this.state.sampleName}*${file.name}`,
          Object.entries(table.rows).map(([rowName, rowCells]) => [
            rowName,
      ...
      <form className="w-full px-6 flex-auto my-4 text-gray-600 text-lg leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row mt-4">
          ...
          <AppText
            ...
            onChange={(event) =>
              this.setState({ xTickValue: event.target.value })
            }
          />
        </div>
        ...
        <div className="flex flex-col justify-center md:flex-row mt-4">
          ...
          <AppText
            ...
            onChange={(event) =>
              this.setState({ accessionColumn: event.target.value })
            }
          />
          ...
          <AppText
            ...
            onChange={(event) =>
              this.setState({ countColumn: event.target.value })
            }
          />
        </div>
        ...
        <div className="flex mt-6 mx-1">
          ...
          >
            ...
            {this.state.loading ? 'Uploading' : 'Upload Tables'}
          </AppFile>
